...
const FALLBACK_SPECIALISTS: Specialist[] = [
  {
    ...
    photo_url: null, instagram_url: null,
    wellhub_url: 'https://wellhub.com/es-es/search/partners/ivan-leptach-masaje-osteopatia-salamanca/',
    google_reviews_url: null, display_order: 1, active: true,
    created_at: new Date().toISOString(), updated_at: new Date().toISOString(),
    services: [
      { id: 's1', specialist_id: '11111111-1111-1111-1111-111111111111', name: 'Osteopatía de columna y articulaciones', description: null, duration_minutes: null, price_eur: null, deposit_eur: null, category: null, allow_home_visits: false, display_order: 1, active: true, created_at: new Date().toISOString() },
      { id: 's2', specialist_id: '11111111-1111-1111-1111-111111111111', name: 'Liberación de cuello y cintura escapular', description: null, duration_minutes: null, price_eur: null, deposit_eur: null, category: null, allow_home_visits: false, display_order: 2, active: true, created_at: new Date().toISOString() },
      { id: 's3', specialist_id: '11111111-1111-1111-1111-111111111111', name: 'Alineación de cadera', description: null, duration_minutes: null, price_eur: null, deposit_eur: null, category: null, allow_home_visits: false, display_order: 3, active: true, created_at: new Date().toISOString() },
      { id: 's4', specialist_id: '11111111-1111-1111-1111-111111111111', name: 'Desbloqueos vertebrales', description: null, duration_minutes: null, price_eur: null, deposit_eur: null, category: null, allow_home_visits: false, display_order: 4, active: true, created_at: new Date().toISOString() },
      { id: 's5', specialist_id: '11111111-1111-1111-1111-111111111111', name: 'Asesoramiento postural y de movimiento', description: null, duration_minutes: null, price_eur: null, deposit_eur: null, category: null, allow_home_visits: false, display_order: 5, active: true, created_at: new Date().toISOString() },
      { id: 's6', specialist_id: '11111111-1111-1111-1111-111111111111', name: 'Terapias complementarias naturales', description: null, duration_minutes: null, price_eur: null, deposit_eur: null, category: null, allow_home_visits: false, display_order: 6, active: true, created_at: new Date().toISOString() },
      { id: 's7', specialist_id: '11111111-1111-1111-1111-111111111111', name: 'Ventosas', description: null, duration_minutes: null, price_eur: null, deposit_eur: null, category: null, allow_home_visits: false, display_order: 7, active: true, created_at: new Date().toISOString() },
    ],
  },
  {
    ...
    photo_url: null, instagram_url: null, wellhub_url: null,
    ...
    created_at: new Date().toISOString(), updated_at: new Date().toISOString(),
    services: [
      { id: 'm1', specialist_id: '22222222-2222-2222-2222-222222222222', name: 'Masaje relajante', description: null, duration_minutes: null, price_eur: null, deposit_eur: null, category: null, allow_home_visits: false, display_order: 1, active: true, created_at: new Date().toISOString() },
      { id: 'm2', specialist_id: '22222222-2222-2222-2222-222222222222', name: 'Masaje descontracturante y deportivo', description: null, duration_minutes: null, price_eur: null, deposit_eur: null, category: null, allow_home_visits: false, display_order: 2, active: true, created_at: new Date().toISOString() },
      { id: 'm3', specialist_id: '22222222-2222-2222-2222-222222222222', name: 'Drenaje linfático y reflexología podal', description: null, duration_minutes: null, price_eur: null, deposit_eur: null, category: null, allow_home_visits: false, display_order: 3, active: true, created_at: new Date().toISOString() },
      { id: 'm4', specialist_id: '22222222-2222-2222-2222-222222222222', name: 'Masaje facial Kobido', description: null, duration_minutes: null, price_eur: null, deposit_eur: null, category: null, allow_home_visits: false, display_order: 4, active: true, created_at: new Date().toISOString() },
      { id: 'm5', specialist_id: '22222222-2222-2222-2222-222222222222', name: 'Vendaje neuromuscular, ventosas y Cross Tape', description: null, duration_minutes: null, price_eur: null, deposit_eur: null, category: null, allow_home_visits: false, display_order: 5, active: true, created_at: new Date().toISOString() },
    ],
  },
];
